...
print(liste_test)
# supprime le 2ème élément (d'indice 1) de la liste
print(np.delete(liste_test, 1, None))
# supprime la 4ème (d'incice 3) colonne (axe 1)
print(np.delete(ma_table.donnees, 3, 1))
# supprime les 2ème et 4ème colonnes
print(np.delete(ma_table.donnees, [1, 3], 1))
...
ma_table_csv.donnees = np.delete(
    ma_table_csv.donnees, 7, 0)  # supprime la 8ème ligne
